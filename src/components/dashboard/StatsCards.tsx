...
export default function StatsCards({ balance, cagr, isLoading, isError }: { balance: string | number; cagr: number; isLoading: boolean; isError: boolean }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
      ...
      <Card className={cn(
        ...
        isPositive ? "border-green-500/20 hover:shadow-green-500/20 hover:shadow-lg" : "border-red-500/20 hover:shadow-red-500/20 hover:shadow-lg"
      )}>
        <div className={cn(
        ...
        <CardContent className="relative">
          <div className={cn("text-4xl font-bold mb-2 tracking-tight drop-shadow-lg", colorClass)}>
            {sign}{cagr.toFixed(2)}%
          </div>
          <p className="text-xs text-muted-foreground font-medium">Annual growth</p>
        </CardContent>
      </Card>
      ...
      <Card className={cn(
        ...
        <CardHeader className="pb-3 relative">
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardTitle className="text-base font-semibold">Hit Rate</CardTitle>
            </div>
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg">
        ...
        <CardContent className="relative">
          ...
          <p className="text-xs text-muted-foreground font-medium">Trade success rate</p>
        </CardContent>
      </Card>
    </div>
  );
